          ...
          <div className="max-w-[1200px] mx-auto space-y-8 md:space-y-12 pb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div 
                ...
                className="group relative bg-white dark:bg-zinc-900/50 p-6 rounded-3xl border border-zinc-200 dark:border-zinc-800/50 shadow-sm flex items-center gap-5 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors overflow-hidden"
              >
                <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 hidden dark:block z-0" style={{ background: `radial-gradient(400px circle at var(--x, 0) var(--y, 0), rgba(16, 185, 129, 0.1), transparent 50%)` }} />
                <div className="h-14 w-14 rounded-full bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-zinc-900 dark:text-white shrink-0 border border-zinc-100 dark:border-zinc-700/50 relative z-10"><DollarSign className="h-6 w-6"/></div>
                <div className="relative z-10"><p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Total Trip Spent</p><h3 className="text-3xl font-black text-zinc-900 dark:text-white tracking-tighter">{symbol}{convert(totalSpent).toLocaleString(undefined, {maximumFractionDigits: 0})}</h3></div>
              </div>
              ...
              >
                <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 hidden dark:block z-0" style={{ background: `radial-gradient(400px circle at var(--x, 0) var(--y, 0), rgba(16, 185, 129, 0.1), transparent 50%)` }} />
                <div className="h-14 w-14 rounded-full bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-zinc-900 dark:text-white shrink-0 border border-zinc-100 dark:border-zinc-700/50 relative z-10"><Users className="h-6 w-6"/></div>
                <div className="relative z-10"><p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Group Size</p><h3 className="text-3xl font-black text-zinc-900 dark:text-white tracking-tighter">{totalMembers} <span className="text-sm font-bold text-zinc-500 tracking-normal ml-1">travelers</span></h3></div>
              </div>
              ...
              <div 
                ...
                className="group bg-zinc-950 p-6 rounded-3xl shadow-xl flex items-center gap-5 text-white relative overflow-hidden border border-zinc-800"
              >
                <div className="absolute top-[-50%] right-[-10%] w-40 h-40 bg-emerald-500/20 rounded-full blur-[60px] z-0"></div>
                <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 hidden dark:block z-0" style={{ background: `radial-gradient(400px circle at var(--x, 0) var(--y, 0), rgba(16, 185, 129, 0.15), transparent 50%)` }} />
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
              ...
              <div className="xl:col-span-7 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                ...
                <div 
                  ...
                  className="group relative bg-white dark:bg-zinc-900/50 p-8 md:p-10 rounded-[2rem] border border-zinc-200 dark:border-zinc-800/50 shadow-sm transition-colors duration-300 overflow-hidden"
                >
                  <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 hidden dark:block z-0" style={{ background: `radial-gradient(800px circle at var(--x, 0) var(--y, 0), rgba(16, 185, 129, 0.06), transparent 40%)` }} />
                    ...
                    {expenses.length === 0 ? (
                      ...
                      <div className="space-y-3 relative z-20">
                        {expenses.map(exp => {
                          ...
                          return (
                            <div key={exp.id} className="group/item flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-950/50 hover:bg-zinc-100 dark:hover:bg-zinc-900 rounded-2xl border border-transparent hover:border-zinc-200 dark:hover:border-zinc-800 transition-all cursor-default">
              ...
              <div className="xl:col-span-5 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                ...
                <div 
                  ...
                  className="group bg-zinc-950 p-8 md:p-10 rounded-[2rem] shadow-2xl text-white relative overflow-hidden border border-zinc-800"
                >
                  ...
                  <div className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 hidden dark:block z-0" style={{ background: `radial-gradient(600px circle at var(--x, 0) var(--y, 0), rgba(16, 185, 129, 0.1), transparent 40%)` }} />
                    ...
                    {settlements.length === 0 ? (
                      ...
                      <div className="space-y-3">
                        {settlements.map((settlement, idx) => (
                          <div key={idx} className="bg-zinc-900/80 hover:bg-zinc-800 border border-zinc-800 p-4 rounded-2xl flex items-center justify-between transition-colors backdrop-blur-md relative z-20">
